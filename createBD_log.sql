...
/* Conectando em 127.0.0.1 via MariaDB or MySQL (TCP/IP), usuário root, usando a senha: Yes... */
...
/* Registros afetados: 93  Registros encontrados: 0  Avisos: 7  Duração de 101 consultas: 0,373 seg. */

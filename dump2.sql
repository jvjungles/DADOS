...
INSERT IGNORE INTO `cantor` (`cod_cantor`, `nome_cantor`, `pais`) VALUES
...
INSERT IGNORE INTO `categoria` (`cod_categoria`, `desc_categoria`) VALUES
	(1, 'MPB'),
	(2, 'Rock'),
	(3, 'Vira'),
	(4, 'Bossa Nova'),
...
INSERT IGNORE INTO `fone` (`cod_fone`, `numero`, `tipo`, `cod_pessoa`) VALUES
	(1, '3333-1111', 'R', 1),
	(2, '4444-1111', 'C', 1),
	(3, '9999-1111', 'L', 1),
	(4, '3333-2222', 'R', 2),
...
INSERT IGNORE INTO `gravacao` (`cod_gravacao`, `cod_gravadora`, `cod_cantor`, `cod_musica`, `data_gravacao`) VALUES
	(1, 1, 1, 1, '2000-07-10'),
	(2, 1, 1, 2, '2000-12-07'),
	(3, 1, 1, 3, '2001-05-30'),
	(4, 3, 8, 4, '2005-12-29'),
...
INSERT IGNORE INTO `gravadora` (`cod_gravadora`, `nome_gravadora`, `pais`) VALUES
...
INSERT IGNORE INTO `musica` (`cod_musica`, `cod_categoria`, `duracao`, `titulo`) VALUES
...
INSERT IGNORE INTO `pessoa` (`cod_pessoa`, `nome_pessoa`) VALUES
	(1, 'Ana'),
	(2, 'Beto'),
	(3, 'Carlos'),
	(4, 'Daniel'),
